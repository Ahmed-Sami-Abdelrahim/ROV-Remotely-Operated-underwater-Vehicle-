...
static uint8_t MotortDirStatus_X = MOVE_STOP;
static uint8_t MotortDirStatus_Y = MOVE_STOP;
static int16_t MotortSpeed_X = 0;
static int16_t MotortSpeed_Y = 0;
...
static void MotorControl_Loop_MotorX(void)
{
    switch(MotortDirStatus_X)
    {
      case MOVE_FORWARD   :
                    ...
                    MotorControl_ROV_MoveForward(MotortSpeed_X);
                    break;
      ...
      case MOVE_BACKWARD   :
                    ...
                    #endif
                    //MotorControl_ROV_Y_MoveStop(0);
                    MotorControl_ROV_MoveBackward(MotortSpeed_X);
                    break; 
      ...
      case MOVE_LEFT   :
                    ...
                    #endif
                    //MotorControl_ROV_Y_MoveStop(0);
                    MotorControl_ROV_MoveLeft(MotortSpeed_X);
                    break;
      ...
      case MOVE_RIGHT : 
                    ...
                    #endif
                    //MotorControl_ROV_Y_MoveStop(0);
                    MotorControl_ROV_MoveRight(MotortSpeed_X);
                    break;
...
static void MotorControl_Loop_MotorY(void)
{
    switch(MotortDirStatus_Y)
    {
      ...
      case MOVE_UP    : 
                    ...
                    #endif
                    //MotorControl_ROV_X_MoveStop(0);
                    MotorControl_ROV_MoveUp(MotortSpeed_Y);
                    break;
      ...
      case MOVE_DOWN  : 
                    ...
                    #endif
                    //MotorControl_ROV_X_MoveStop(0);
                    MotorControl_ROV_MoveDown(MotortSpeed_Y);
                    break;
      case MOVE_STOP  :  
      default    : 
                    #if 0
...
{
 MotorControl_Loop_MotorX(); 
 MotorControl_Loop_MotorY();
}
