...
void MQTT_SubscrbersWaitAndRead(void)
{
  ...
  while ((subscription = mqtt.readSubscription(200))) 
  {
    ...
    if (subscription == &light_ctrl_r_sub)
    {
      ...
      SERIAL_DEBUG.print((char *)light_ctrl_r_sub.lastread);
      SERIAL_DEBUG.print(LightR);
      #endif
    ...
    if (subscription == &light_ctrl_l_sub)
    {
      ...
      SERIAL_DEBUG.print((char *)light_ctrl_l_sub.lastread);
      SERIAL_DEBUG.print(LightL);
      #endif
